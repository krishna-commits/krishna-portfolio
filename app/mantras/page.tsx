...
export default function MantrasPage() {
    return (
        <div className="max-w-4xl mx-auto  py-10 sm:py-10 lg:py-15">
            ...
            Mantras : In-Depth Insights and Academic Exploration
            </h1>
            <p className="mt-1 mb-8 text-md tracking-tight  dark:text-muted-foreground text-slate-500 font-serif ">
            The mantras Core combines academic findings, conference highlights, coding practices, and theoretical summaries in a structured, mantras-focused format for continuous learning and exploration.
            </p>
            <MantrasCard/>
        </div>
    )
