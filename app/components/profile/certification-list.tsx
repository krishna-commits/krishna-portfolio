              ...
              <Dialog>
                ...
                <DialogContent className="h-fit">
                  <DialogHeader className="pt-9 text-center flex flex-col items-center space-y-2">
                    <DialogTitle className="dark:text-foreground text-cyan-950 font-normal font-serif text-3xl md:text-3xl tracking-tighter text-center">{item.title}</DialogTitle>
